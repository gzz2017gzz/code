    ...
    */
    ...
    public void delete() {
	    ...
	    request.delete(id, new Response.Listener<String>() {
            public void onResponse(String res) {
                DLResult<Integer> result = gson.fromJson(res, new TypeToken<DLResult<Integer>>() {}.getType());
                if (result.isSuccess()) {
                    // TODO 请求成功后的代码
                } else {
    ...
    public void queryList() {
        ...
        request.queryList(cond, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject json) {
                DLResult<List<${upp}>> result = gson.fromJson(json.toString(), new TypeToken<DLResult<List<${upp}>>>() {}.getType());
                if (result.isSuccess()) {
    ...
    public void queryPage() {
        ...
        request.queryPage(cond, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject json) {
                ...
                DLResult<Page<${upp}>> result = gson.fromJson(json.toString(), new TypeToken<DLResult<Page<${upp}>>>() {}.getType());
                if (result.isSuccess()) {
    ...
    public void findById() {
	    ...
	    request.findById(id, new Response.Listener<String>() {
            public void onResponse(String res) {
                DLResult<${upp}> result = gson.fromJson(res, new TypeToken<DLResult<${upp}>>() {}.getType());
                if (result.isSuccess()) {
    ...
    public void queryCount() {
        ...
        request.queryCount(cond, new Response.Listener<JSONObject>() {
            public void onResponse(JSONObject json) {
                DLResult<Long> result = gson.fromJson(json.toString(), new TypeToken<DLResult<Long>>() {}.getType());
                if (result.isSuccess()) {
