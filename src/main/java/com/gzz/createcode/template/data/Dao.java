...
public class Dao {
	public static StringBuilder create(String pName, String clsUpp, String auth, String cName, List<Field> fList, String tName, String idType) {
		...
		sb.append("\r\n\tpublic " + clsUpp + "Dao () {");
		sb.append("\r\n\t\tselect.append(\"SELECT " + Utils.addLower(fList, "t.", ",").toString() + " FROM " + tName + " t WHERE 1=1\");");
		sb.append("\r\n");
		sb.append("\r\n\t\tinsert.append(\"INSERT INTO " + tName + " (" + Utils.add(fList, "", ",", 2).toString() + ")\");");
		sb.append("\r\n\t\tinsert.append(\" VALUES (" + Utils.add(fList, ":", ",", 2) + ")\");");
		sb.append("\r\n\t}");
		sb.append(Utils.methodNote("新增" + cName + "记录"));
		sb.append("\r\n\tpublic int save(" + clsUpp + " vo) {");
		sb.append("\r\n\t\tString sql = \"REPLACE INTO " + tName + " (" + Utils.addLower(fList, "", ",").toString() + ") VALUES "
				+ Utils.add(fList.size()) + " \";");
		sb.append("\r\n\t\tObject[] params ={");

		sb.append(Utils.add(fList, "vo.get", "(),") + "};");
		...
		sb.append("\r\n\t\tString sql = \"UPDATE " + tName + " SET " + Utils.add(fList, "", "=?,", 2).toString() + " WHERE " + idName + "=? \";");
		sb.append("\r\n		Object[] params = {");
		sb.append(Utils.add(fList, "vo.get", "(),", 1) + ",vo.get" + Utils.firstUpper(idName) + "()};");
		sb.append("\r\n		return jdbcTemplate.update(sql, params);");
		sb.append("\r\n	}");
